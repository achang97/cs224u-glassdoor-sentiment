...
def scrape(field, review, author):
    ...
    def scrape_pros(review):
        try:
            pros = review.find_element_by_class_name('description').find_elements_by_class_name('mt-md')[0]
    ...
    def scrape_cons(review):
        try:
            cons = review.find_element_by_class_name('description').find_elements_by_class_name('mt-md')[1]
    ...
    def scrape_advice(review):
        try:
            advice = review.find_element_by_class_name('description').find_elements_by_class_name('mt-md')[2]
...
def get_current_page():
    ...
    paging_control = browser.find_element_by_class_name('eiReviews__EIReviewsPageContainerStyles__pagination noTabover mt')
